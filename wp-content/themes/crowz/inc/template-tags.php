...
if ( ! function_exists( 'crowz_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function crowz_posted_on() {
...
if ( ! function_exists( 'crowz_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function crowz_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'crowz_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function crowz_entry_footer() {
...
if ( ! function_exists( 'crowz_post_thumbnail' ) ) :
	/**
